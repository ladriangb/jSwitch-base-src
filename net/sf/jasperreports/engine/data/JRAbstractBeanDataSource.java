 ...
 * @version $Id: JRAbstractBeanDataSource.java 4595 2011-09-08 15:55:10Z teodord $
 */
	...
	protected static Object getBeanProperty(Object bean, String propertyName) throws JRException
	{
		...
		//bc
                if(bean instanceof Object[])
                {
                        try
			{
				value = ((Object[])bean)[Integer.parseInt(propertyName)];
			}
			catch (java.lang.NumberFormatException e)
			{
				throw new JRException("Error retrieving field value from bean : " + propertyName+
                                        ", the field description must be integer", e);
			}                        
                }else if (isCurrentBeanMapping(propertyName))
		{
			value = bean;
		}
		else if (bean != null)
